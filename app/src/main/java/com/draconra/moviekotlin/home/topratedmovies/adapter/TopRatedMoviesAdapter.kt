package com.draconra.moviekotlin.home.topratedmovies.adapter
...
class TopRatedMoviesAdapter constructor(private val imageLoader: ImageLoader,
                                        private val onMovieSelected: (Movie, View) -> Unit) : RecyclerView.Adapter<TopRatedMoviesAdapter.MovieCellViewHolder>() {
